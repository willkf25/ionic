      ...
      this.http.get(url)
        ...
        .subscribe(data => {
          ...
          if(this.data.ip == '187.115.154.122') {
            window.localStorage.setItem('host', "http://192.168.10.221:8080/webserver/prd/scpa/");
          } else {
            window.localStorage.setItem('host', "http://www.qualiagua.com:8080/webserver/prd/scpa/");
          }
          //loading.dismiss()
          resolve(this.data);
