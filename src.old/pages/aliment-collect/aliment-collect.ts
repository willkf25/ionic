...
@IonicPage()
@Component({
  selector: 'page-aliment-collect',
  templateUrl: 'aliment-collect.html',
})
export class AlimentCollectPage {
  ...
  public TypeCollect;
  public utilizacao = []
  public title = "alimento"; //define qual title da página, se é alimento ou cosmético
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad AlimentCollectPage');
  }
  ...
  public Salvar() {
    ...
    if ( this.Ctemp_branco == undefined || this.Ctempamostra == undefined
      || this.Camostra == undefined || this.Cfabricacao == undefined || this.CidAmostra == undefined
      ...
      if (this.Ctemp_branco == 0) { this.Ctemp_branco = this.Ctemp_brancoOutro; this.auxTempBrancoOutro = 1; }
      ...
      var coleta = {
        ...
        auxAlimentUtilizacaoOutro: this.auxUtilizacaoOutro ,
        auxAlimentTempBrancoOutro: this.auxTempBrancoOutro,
